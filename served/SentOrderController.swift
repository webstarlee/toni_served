//
//  guestViewMyOrderController.swift
//  served
//
...
class SentOrderController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableNumber.text = Singletone.table_number
    ...
    @IBAction func goTo_SelectedResMain(_ sender: Any) {
